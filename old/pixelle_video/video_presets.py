...
VIDEO_PRESETS: List[Dict[str, Any]] = [
    {
        ...
        "models": [
            {"id": "doubao-seedance-2-0-260128", "name": "SeedDance 2.0 (最新)"},
            {"id": "doubao-seedance-1-0-pro-250428", "name": "SeedDance 1.0 Pro"},
            {"id": "doubao-seedance-1-0-lite-250428", "name": "SeedDance 1.0 Lite"},
        ],
