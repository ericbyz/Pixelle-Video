...
Implements the progressive UI for generating videos from user-provided assets.
"""
...
class AssetBasedPipelineUI(PipelineUI):
    ...
    def render(self, pixelle_video: Any):
        steps = [
            tr("progressive.step.assets"),
            tr("progressive.step.settings"),
        ...
        with render_step_workspace():
            # ====================================================================
            # Step 1: Asset Upload & Video Info
            # ====================================================================
            if active_step == 0:
