...
class DigitalHumanPipelineUI(PipelineUI):
    ...
    def render(self, pixelle_video: Any):
        steps = [
            tr("progressive.step.character"),
            tr("progressive.step.product"),
        ...
        with render_step_workspace():
            ...
            # ====================================================================
                ...
                mode_params = self.render_digital_human_mode(params.get("character_assets", []))
                params.update({
                    **mode_params,
